...
<section class="container">
  ...
  <form class="form-horizontal" style="margin-top: 59px" action="{{ route('agenda.store') }}" method="post">
    @csrf
    ...
    <div class="form-group">
      <div class="col-sm-10">
        ...
        <div class="input-group date imputs">
          <input type="date" name="date" class="form-control" id="exemplo" placeholder="Clique para abrir o calendario">
