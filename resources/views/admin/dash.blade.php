...
<head>
    ...
    <title>Area administrativa/BarberRio</title>
...
<body class="c-app">
    ...
    <script src="{{ asset('admin/node_modules/@coreui/coreui/dist/js/coreui.bundle.min.js') }}">
    </script>
    <!--[if IE]><!-->
